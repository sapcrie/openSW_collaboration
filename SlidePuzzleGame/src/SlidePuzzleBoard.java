...
public class SlidePuzzleBoard {
    ...
    /** Constructor - SlidePuzzleBoard 초기 퍼즐 보드 설정 - 감소하는 순으로 나*/
    public SlidePuzzleBoard() {
        ...
        for (int row = 0; row < 4; row++)
            for (int col = 0; col < 4; col++) {
                board[row][col] = new PuzzlePiece(""+number,number, this);
                number -= 1;
            }
        board[3][3] = null;
        empty_row = 3;
...
//        System.out.println("움직임" + w);
        ...
        System.out.println(w + "번을 성공적으로 움직였습니다 ");// + "빈 칸 " + empty_row + " "+empty_col);
        return true;
    }
